...
class CNNScraper(BaseScraper):
    """
    Scraper for CNN (https://www.cnn.com/)
    """
    ...
    def get_article_urls(self, category=None, limit=10):
        ...
        try:
            ...
            for article in articles:
                ...
                if article_url and (('/2025/' in article_url) or ('/2024/' in article_url)) and '/index.html' in article_url and article_url not in article_urls:
            ...
            logging.error(f"Error fetching articles from CNN: {str(e)}")
            return []
    
    def scrape_article(self, url):
        """
        Parse a single article from CNN
        ...
        try:
            ...
            if date_str:
                try:
                    ...
                    logging.error(f"Error parsing date from CNN: {str(e)}")
            ...
            logging.error(f"Error parsing article from CNN: {str(e)}")
            return None