...
class NPRScraper(BaseScraper):
    """
    Scraper for NPR (https://www.npr.org/)
    """
    ...
    def get_article_urls(self, category=None, limit=10):
        ...
        try:
            ...
            logging.error(f"Error fetching articles from NPR: {str(e)}")
            return []
    
    def scrape_article(self, url):
        """
        Parse a single article from NPR
        ...
        try:
            ...
            if date_str:
                try:
                    ...
                    logging.error(f"Error parsing date from NPR: {str(e)}")
            ...
            logging.error(f"Error parsing article from NPR: {str(e)}")
            return None